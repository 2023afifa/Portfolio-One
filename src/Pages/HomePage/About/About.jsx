const About = () => {
    return (
        <div className="pt-36 pb-5 lg:px-60 bg-slate-50">
            ...
            <p className="text-lg text-center my-6">Welcome to my corner of the web! I'm Afifa, an university graduate and an enthusiastic Junior Frontend Developer. My journey in the world of coding began with a fascination for transforming lines of code into captivating digital experiences. Armed with a solid foundation in HTML, CSS, and JavaScript, I've delved deeper into the realms of React, Firebase, MongoDB, Node.js, and Express.js, honing my skills to bring ideas to life.
            ...
            <div className="my-20 lg:flex lg:justify-around lg:items-center">

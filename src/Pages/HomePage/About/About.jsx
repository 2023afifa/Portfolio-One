...
const About = () => {
    ...
    return (
        <div className="pt-36 pb-5 lg:px-60 bg-slate-50">
            ...
            <p className="text-lg text-justify mx-5  md:mx-8 lg:mx-3 my-6" data-aos="fade-up" data-aos-duration="2000">
            ...
            <div className="mx-10 md:mx-5 lg:mx-3 my-20 md:flex md:justify-around md:items-center" data-aos="fade-up" data-aos-duration="2000">

const Projects = () => {
    return (
        <div className="pt-36 pb-5 lg:px-20 bg-slate-50">
            ...
            <div className="hero bg-slate-200 py-20 mb-10">
                <div className="hero-content flex-col lg:flex-row">
                    <img src="https://i.ibb.co/CmXhFxK/Project2.png" className="max-w-xl rounded-lg shadow-2xl" />
                    <div>
            ...
            <div className="hero bg-slate-200 py-20 mb-10">
                <div className="hero-content flex-col lg:flex-row">
                    <img src="https://i.ibb.co/0CLP7FX/Project3.png" className="max-w-xl rounded-lg shadow-2xl" />
                    <div>

...
const Skill = () => {
    ...
    return (
        <div className="pt-16 md:px-10 lg:px-60 bg-gray-50" data-aos="flip-left" data-aos-duration="2000">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 justify-center my-10">
